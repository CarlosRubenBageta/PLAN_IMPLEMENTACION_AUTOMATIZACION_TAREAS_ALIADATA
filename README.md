...
| 8. Pruebas | **Casos preparados** — ejecución real pendiente, requiere acción de Rubén en Google Workspace |
| 9 a 10 | Pendientes |
...
**Acción pendiente de Rubén (no de Cowork) para poder cerrar la Fase 8:** copiar los archivos `codigo/*.gs` a un proyecto de Apps Script de prueba, configurar el modo prueba aislado, ejecutar los 30 casos de `pruebas/CASOS_DE_PRUEBA.md` y completar `pruebas/resultados/RESULTADOS_FASE_8.md` con la evidencia real. Recién entonces Cowork puede redactar el acta definitiva y continuar con la Fase 9.
